...
# ------------------------------------------------
API_ID = int(os.environ.get("API_ID", "38626742"))
# ------------------------------------------------
API_HASH = os.environ.get("API_HASH","c2ada3e4cb670b24f10eeaec5ec8fc0d")
# ------------------------------------------------
BOT_TOKEN = os.environ.get("BOT_TOKEN", "5348309514")
# ------------------------------------------------
BOT_USERNAME = os.environ.get("BOT_USERNAME", "@Narutonevergiveup_bot")
BOT_TEXT = "naruto"
# ------------------------------------------------
OWNER_ID = int(os.environ.get("OWNER_ID", "847950419"))
# ------------------------------------------------
# //LOG CHANNEL ID 
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1004208214455"))

# //FORCE_CHANNEL_ID
CHANNEL_ID2 = int(os.environ.get("CHANNEL_ID2", "-1004208214455")) 
# ------------------------------------------------
...
# -----------------------------------------------
PREMIUM_LOGS = int(os.environ.get("PREMIUM_LOGS", "-1004208214455"))
# -----------------------------------------------
